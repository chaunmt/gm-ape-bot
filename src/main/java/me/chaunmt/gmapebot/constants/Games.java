...
public class Games {
    ...
    public static String getRandomGame() {
        return ALL[RandomGenerator.getRandomInt(ALL.length)];
    }

    public static final String VALHEIM = ""
            + "Server info:\n"
